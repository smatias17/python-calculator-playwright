...
def test_should_validate_operation_position_v1_ec():
    value_v1 = 'test'
...
def test_should_validate_operation_position_v2_ec():
    value_v2 = '1'
...
def test_should_validate_special_symbols_v1_ec():
    value_v1 = "\\"
...
def test_should_validate_special_symbols_v2_ec():
    value_v2 = '"'
...
def test_should_validate_special_symbols_v3_ec():
    value_v3 = '#'
...
def test_should_validate_one_argument_ec():
...
def test_should_validate_three_argument_ec():
...
def test_should_validate_four_argument_ec():
...
def test_should_add_float_numbers_doc_ec():
